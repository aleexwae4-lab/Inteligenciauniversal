...
test('v88 is the live alias over v87 planning, v86 verification and the resilience chain while v82 remains independently callable over v81',()=>{
  ...
  assert.match(v60,/capacity-chat-v88\.js/);
