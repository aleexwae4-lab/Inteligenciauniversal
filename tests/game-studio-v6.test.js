...
test('legacy v6 remains compatible while active recovery upgrades first 3D build to v9',async()=>{
...
test('active Game Studio replaces an incomplete AI 3D scaffold with audited v9 output',async()=>{
  const weak={
    plan:'3D incompleto',
    files:[
