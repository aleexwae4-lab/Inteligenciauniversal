...
test('public v60 compatibility alias advances through v106, v91, v90, v89, v88 and v87 while keeping v86 as factual gate',()=>{
  const v60=fs.readFileSync(new URL('../api/capacity-chat-v60.js',import.meta.url),'utf8');
  const v106=fs.readFileSync(new URL('../api/capacity-chat-v106.js',import.meta.url),'utf8');
  ...
  assert.match(v60,/capacity-chat-v106\.js/);
