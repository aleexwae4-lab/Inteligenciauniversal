...
test('legacy v8 World Builder remains compatible while active recovery upgrades to v13',async()=>{
...
test('World Builder v8 persistence validates source iframe and portable world contract',()=>{
  ...
  assert.match(workspace,/\['wae-game-studio\/v8','wae-game-studio\/v9','wae-game-studio\/v10','wae-game-studio\/v11','wae-game-studio\/v12'\]\.includes\(data\.studio\)/);
