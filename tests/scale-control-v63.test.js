...
test('v82 compatibility chain preserves v81 health, v77 GPU, v63 distributed admission and local governor underneath',async()=>{
  ...
  assert.match(compatibility,/capacity-chat-v82\.js/);
