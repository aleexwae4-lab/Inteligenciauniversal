...
test('v87 planner wraps v86 factuality while preserving the v84 -> v83 -> v81 -> v77 -> v63 chain and v82 compatibility',async()=>{
  ...
  assert.match(compatibility,/capacity-chat-v87\.js/);
