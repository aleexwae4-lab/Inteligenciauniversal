...
public final class MainActivity extends Activity {
    private static final String APP_URL = "https://wae-inteligencia-universal-vt3h.onrender.com/?mobile=1&app=android&source=native";
    ...
    private void configureWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " WAEUniversalCoreAndroid/1.1");
