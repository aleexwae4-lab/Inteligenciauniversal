...
const norm=value=>text(value,6000).normalize('NFD').replace(/[\u0300-\u036f]/g,'').toLowerCase();
...
const DOMAIN_RULES=[
  ['medicine',/\b(medic|salud|clinical|clinica|farmaco|tratamiento|enfermedad|diagnost|paciente|cancer|cardio|neurolog|epidemi|biomed)\b/i],
  ['science',/\b(ciencia|cientific|fisica|quimica|biologia|genetica|astronom|matematic|estadistic|paper|estudio|doi|arxiv|pubmed)\b/i],
  ['economics',/\b(economia|economico|pib|gdp|inflacion|desempleo|poblacion|ingreso|deuda|pobreza|desarrollo|world bank|banco mundial)\b/i],
  ['software',/\b(software|github|npm|node|javascript|typescript|python|pypi|paquete|libreria|framework|sdk|api|repositorio|version)\b/i],
  ['law',/\b(ley|legal|juridic|jurisprudencia|codigo|reglamento|constitucion|tribunal|sentencia|delito|fiscal|norma oficial)\b/i],
  ['books',/\b(libro|books?|novela|obra literaria|isbn|autor|escritor|biblioteca|gutenberg|open library)\b/i],
  ['history',/\b(historia|historico|guerra|siglo|imperio|revolucion|antiguo|biografia)\b/i],
  ['geography',/\b(pais|ciudad|capital|geografia|territorio|continente|rio|montana|oceano|poblacion de)\b/i],
  ['business',/\b(empresa|mercado|industria|negocio|startup|fintech|saas|ingresos|competidor)\b/i],
  ['general',/.*/]
];
