...
export async function executeMission(payload={}){
  ...
  if(quick){
    ...
    response.metadata={...response.metadata,quality,cognitivePolicy,repairAttempted:false,fastLane:true,supremacy:{path:'instant_conversation',cacheHit:false,tournamentUsed:false}};
  ...
  if(cacheEligible){
    ...
    if(hit){
      ...
      response.metadata={...response.metadata,quality,cognitivePolicy,repairAttempted:false,cacheHit:true,cacheSimilarity:hit.similarity,supremacy:{path:'semantic_cache',cacheHit:true,tournamentUsed:false}};
  ...
  response.metadata={...response.metadata,quality,cognitivePolicy,repairAttempted,supremacy:{path:'generation',cacheHit:false,tournamentUsed,candidateCount}};
