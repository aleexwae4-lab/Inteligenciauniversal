...
import { buildMultimodalVerificationLoop, verificationLoopInstruction, publicVerificationLoop, MULTIMODAL_VERIFICATION_LOOP_VERSION } from './multimodal-verification-loop-v1.js';
...
export async function executeMission(payload={}){
  ...
  const verificationLoop=buildMultimodalVerificationLoop({synthesis:multimodalEvidenceSynthesis,composer:multimodalAnswerComposer,toolResults});
