...
import { buildMultimodalEvidenceDecision, evidenceDecisionInstruction, publicEvidenceDecision, MULTIMODAL_EVIDENCE_DECISION_VERSION } from './multimodal-evidence-decision-v1.js';
...
export async function executeMission(payload={}){
  ...
  const multimodalEvidenceDecision=buildMultimodalEvidenceDecision({verification:verificationLoop,synthesis:multimodalEvidenceSynthesis,truthConflict:multimodalTruthConflict,temporalCausal:multimodalTemporalCausal});
