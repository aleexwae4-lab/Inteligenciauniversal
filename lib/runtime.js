...
export async function executeMission(payload={}){
  ...
  if(epistemic.unsupportedRisk==='high'&&!sources.length){
    try{
  ...
  if(epistemic.unsupportedRisk==='high'&&!sources.length) throw Object.assign(new Error('epistemic_guard_rejected'),{code:'UNVERIFIED_CLAIM',statusCode:503,epistemic});
