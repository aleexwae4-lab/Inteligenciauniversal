...
export function capabilitySnapshot({providers=providerRegistry(),tools=toolRegistry(),memory=memoryStatus()}={}) {
  ...
  return {
    ...
    foundry:{version:'wae-product-foundry/v5',browserExecutable:['web_app','website','dashboard','presentation','game_2d','game_3d','simulation_3d','creative_tool','pwa','digital_product'],sourceTargets:['mobile_app','desktop_app','api_service','automation'],threeD:{engine:'WebGL/WebGL2 vanilla',studio:'wae-game-studio/v6',nativeFallback:true,sceneGraph:true,physics:'AABB/local',particles:true,webAudio:true,levelRuntime:true,sceneEditor:true,externalRuntimeRequired:false},export:['zip-source','wae-project-json','html-preview']},
    intelligence:{
