...
function capabilityAnswer(snapshot){
  ...
  return [
    ...
    '- **Ingeniería y Product Foundry:** arquitectura, código, debugging, pruebas, APIs, backend/frontend y construcción de productos digitales. La Fábrica v5 puede generar juegos 2D/3D WebGL, simulaciones 3D, apps web/PWA, dashboards, presentaciones, herramientas creativas y paquetes fuente para móvil, escritorio, APIs y automatizaciones.',
