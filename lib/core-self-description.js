...
export function coreSelfResponse({providers=providerRegistry(),tools=toolRegistry(),memory=memoryStatus()}={}) {
  ...
  return [
    ...
    '**Puedo ayudarte** a investigar, redactar, diseñar productos, revisar código y abordar retos mundiales con evidencia. Código propuesto no equivale a código ejecutado.',
    '**Ingeniería y organizaciones:** diseño y mantenimiento asistido de aeronaves, motores, fábricas, robots, chips y universidades. No opero equipos físicos ni certifico intervenciones.',
    '**Proyectos y economía:** apoyo en obras, empresas, laboratorios, inversiones y finanzas. No garantizo ganancias.',
