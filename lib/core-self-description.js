...
export const CORE_CAPABILITY_VERSION='universal-capability-registry/v147-game-studio';
...
export function capabilitySnapshot({providers=providerRegistry(),tools=toolRegistry(),memory=memoryStatus()}={}) {
  ...
  return {
    ...
    foundry:{version:'wae-product-foundry/v5',browserExecutable:['web_app','website','dashboard','presentation','game_2d','game_3d','simulation_3d','creative_tool','pwa','digital_product'],sourceTargets:['mobile_app','desktop_app','api_service','automation'],threeD:{engine:'WebGL/WebGL2 vanilla',studio:'wae-game-studio/v7',nativeFallback:true,sceneGraph:true,physics:'AABB/local',particles:true,webAudio:true,levelRuntime:true,sceneEditor:true,sceneHierarchy:true,entityInspector:true,transformXYZ:true,transformGizmo:true,materialEditor:true,sceneUndo:true,scenePersistence:true,externalRuntimeRequired:false},export:['zip-source','wae-project-json','html-preview']},
    intelligence:{
...
function capabilityAnswer(snapshot){
  ...
  return [
    ...
    '- **Ingeniería, Fábrica de software y Product Foundry:** arquitectura, código, debugging, pruebas, APIs, backend/frontend y construcción de productos digitales. La Fábrica v5 puede generar juegos 2D/3D WebGL, simulaciones 3D, apps web/PWA, dashboards, presentaciones, herramientas creativas y paquetes fuente para móvil, escritorio, APIs y automatizaciones. Game Studio v7 añade escena/entidades, físicas locales, materiales, partículas, Web Audio y niveles, más jerarquía de escena, inspector de entidad, transformación X/Y/Z, gizmos, duplicar/eliminar, edición de materiales, deshacer y persistencia real de scene.json/main.js; conserva recuperación 3D nativa si falla la ruta generativa.',
