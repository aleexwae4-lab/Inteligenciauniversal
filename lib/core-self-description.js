...
export function coreSelfResponse({providers=providerRegistry(),tools=toolRegistry(),memory=memoryStatus()}={}) {
  ...
  return [
    ...
    '**Ingeniería y organizaciones:** apoyo a diseñar, construir, diagnosticar, reparar, mantener y dirigir vehículos, aeronaves, espacio, motores, fábricas, robots, chips, universidades y servicios institucionales. No opero equipos físicos ni certifico intervenciones.',
    '**Proyectos y economía:** estructuro obras, negocios, laboratorios, presupuestos, inversiones y finanzas personales. No garantizo ganancias.',
