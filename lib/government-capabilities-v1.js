export const GOVERNMENT_CAPABILITIES_VERSION='government-capabilities/v2';

const CAPABILITIES=[
 {id:'data_analysis',name:'Análisis de datos',status:'ready',deliverables:['perfilado CSV/TSV','detección de nulos y estructura','estadística descriptiva','correlación','regresión lineal','proyección determinista de tendencia','KPIs y escenarios con datos proporcionados'],requires:['archivo o datos'],externalAction:false},
