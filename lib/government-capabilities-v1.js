export const GOVERNMENT_CAPABILITIES_VERSION='government-capabilities/v3';

const CAPABILITIES=[
 {id:'data_analysis',name:'Análisis de datos',status:'ready',deliverables:['perfilado CSV/TSV','detección de nulos y estructura','estadística descriptiva','correlación','regresión lineal','proyección determinista de tendencia','detección de outliers','análisis temporal básico','clustering k-means, perfil de calidad de datos y análisis A/B aproximado','KPIs y escenarios con datos proporcionados'],requires:['archivo o datos'],externalAction:false},
 {id:'public_policy',name:'Política pública',status:'ready',deliverables:['marcos de análisis','matrices de impacto','escenarios','indicadores','informes basados en evidencia','comparación de alternativas y supuestos'],requires:['objetivo y supuestos; fuentes cuando se requieran datos actuales'],externalAction:false},
 ...
 {id:'cybersecurity',name:'Ciberseguridad defensiva',status:'ready',deliverables:['análisis de logs aportados','inventario de riesgos','hardening','controles','playbooks de respuesta','priorización de riesgos'],requires:['logs, arquitectura o configuración proporcionada'],externalAction:false},
