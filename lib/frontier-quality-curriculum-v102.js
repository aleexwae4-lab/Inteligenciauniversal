...
export function assessFrontierQualityV102({question='',mode='general',quality={},sources=[],latencyMs=null,degraded=false}={}){
  ...
  const premiumPass=!quality?.critical&&score>=targetInfo.target&&!quality?.requirementCoverage?.hardFailure&&(!targetInfo.premiumRequired||requirementCoverage>=.9)&&(!research||sourceCount>0);
