export const RETRIEVAL_SECURITY_VERSION='retrieval-security-gateway/v70';
...
const ALLOWED_HOSTS=new Set([
  'api.openalex.org','api.crossref.org','www.wikidata.org','en.wikipedia.org','es.wikipedia.org','eutils.ncbi.nlm.nih.gov','www.ebi.ac.uk','export.arxiv.org','openlibrary.org','zenodo.org'
]);
...
export function untrustedEvidenceFrame(record={}){
  ...
  return{type:'knowledge_evidence',trust:'retrieved_untrusted_data',disclosure:'public',source:String(record.source?.id||record.source_id||'unknown'),content:excerpt.text,injection_detected:excerpt.injection_detected,security_version:RETRIEVAL_SECURITY_VERSION};
}
