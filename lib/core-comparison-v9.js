...
export function coreComparisonFastAnswer(message=''){
 ...
 if(q.length>105||!/^(?:(?:hola|oye|dime|me dices|una pregunta|por favor) )*(?:(?:tu|universal core|wae os) )?(?:(?:puedes|podrias|puede|podria|podemos) )?(?:competir|compites|compite|competencia) (?:contra|con|vs|versus) google(?: (?:search|gemini))?$/.test(q))return null;
