...
export function assuranceRecoveryPlanV101(error={}){
  ...
  return{
    ...
    // Deadline recovery stays intentionally short after the primary 18-30s budget.
    // Provider collapse/low-quality recovery gets enough time for one real Supabase
    // bootstrap + model generation instead of prematurely falling into continuity text.
    rescueBudgetMs:deadline?1_500:8_000,
