...
export async function generateWithFallback({ provider='auto', system, message, history=[], mode='general', webEnabled=false, qualityGate=null, budgetMs=38000, retryColdStart=true, attemptTimeoutMs=16500 }) {
