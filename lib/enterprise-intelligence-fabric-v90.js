...
const PRIVATE_ACCESS_RX=/\b(secretos?|secrets?|credencial(?:es)? privada|private key|acceso interno no autorizado|hackea|hack|bypass|elude autenticacion|roba|filtra|exfiltra)\b/i;
