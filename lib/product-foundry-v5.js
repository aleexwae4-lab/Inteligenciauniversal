...
import { GAME_STUDIO_VERSION, createNativeGameStudioProject, inspectGameStudioProject, supportsNativeGameStudio } from './game-studio-v12.js';
...
function profileInstructions(profile){
  ...
  if(profile==='game_3d'||profile==='simulation_3d')base.push(
    ...
    'GAME STUDIO V12: incluye scene.json con engine wae-game-studio/v12, world.json, logic.json con schema wae-logic/v12, npc.json, combat.json, story.json con schema wae-story/v12 y savegame.json con schema wae-save/v12. Debe implementar quests, objetivos encadenados, árboles de diálogo, decisiones, variables narrativas, journal y guardado/restauración de partida.'
  );
