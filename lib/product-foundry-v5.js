...
import { GAME_STUDIO_VERSION, createNativeGameStudioProject, inspectGameStudioProject, supportsNativeGameStudio } from './game-studio-v8.js';
...
function profileInstructions(profile){
  ...
  if(profile==='game_3d'||profile==='simulation_3d')base.push(
    ...
    'GAME STUDIO V8: incluye scene.json con engine wae-game-studio/v8 y world.json con schema wae-world/v8. Debe implementar múltiples escenas, prefabs, spawn points, triggers, transiciones, misiones, cámara e iluminación editables, además del editor visual, físicas, partículas y Web Audio.'
  );
