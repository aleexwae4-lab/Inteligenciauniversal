...
import { GAME_STUDIO_VERSION, createNativeGameStudioProject, inspectGameStudioProject, supportsNativeGameStudio } from './game-studio-v10.js';
...
function profileInstructions(profile){
  ...
  if(profile==='game_3d'||profile==='simulation_3d')base.push(
    ...
    'GAME STUDIO V10: incluye scene.json con engine wae-game-studio/v10, world.json, logic.json con schema wae-logic/v10 y npc.json con schema wae-npc/v10. Debe implementar personajes con facciones, percepción, máquina de estados, patrullaje, persecución, interacción, diálogo, objetivos y eventos conectados al Logic Builder.'
  );
