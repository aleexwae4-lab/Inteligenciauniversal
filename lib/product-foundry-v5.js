...
import { GAME_STUDIO_VERSION, createNativeGameStudioProject, inspectGameStudioProject, supportsNativeGameStudio } from './game-studio-v7.js';
...
function profileInstructions(profile){
  ...
  if(profile==='game_3d'||profile==='simulation_3d')base.push(
    ...
    'GAME STUDIO V7: incluye scene.json con engine wae-game-studio/v7, entidades, materiales y niveles; main.js debe implementar físicas locales, partículas, Web Audio y editor visual con jerarquía, inspector, transformación XYZ, gizmos, duplicar/eliminar, materiales y persistencia de escena además del render 3D.'
  );
