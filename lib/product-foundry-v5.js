...
import { GAME_STUDIO_VERSION, createNativeGameStudioProject, inspectGameStudioProject, supportsNativeGameStudio } from './game-studio-v11.js';
...
function profileInstructions(profile){
  ...
  if(profile==='game_3d'||profile==='simulation_3d')base.push(
    ...
    'GAME STUDIO V11: incluye scene.json con engine wae-game-studio/v11, world.json, logic.json con schema wae-logic/v11, npc.json y combat.json con schema wae-combat/v11. Debe implementar vida, stamina, inventario, consumibles, pickups, loot, daño NPC, checkpoints, respawn y eventos conectados al Logic Builder.'
  );
