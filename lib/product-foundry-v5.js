...
import { GAME_STUDIO_VERSION, createNativeGameStudioProject, inspectGameStudioProject, supportsNativeGameStudio } from './game-studio-v9.js';
...
function profileInstructions(profile){
  ...
  if(profile==='game_3d'||profile==='simulation_3d')base.push(
    ...
    'GAME STUDIO V9: incluye scene.json con engine wae-game-studio/v9, world.json con schema wae-world/v8 y logic.json con schema wae-logic/v9. Debe implementar múltiples escenas, prefabs, spawn points, triggers, misiones y un Logic Builder visual con eventos, condiciones, acciones, playtest y persistencia.'
  );
