...
export function classifyTask(message,{mode='general',attachments=[]}={}){
  ...
  const path=['simple_chat','factual'].includes(category)?'FAST':['high_risk','web_research','reasoning','local_intelligence','automation','product_engineering'].includes(category)?'DEEP':'STANDARD';
