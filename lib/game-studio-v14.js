...
function wireV14(js){
  ...
  js=js.replace("window.WAEGameStudio={version:'wae-game-studio/v13'", "window.WAEGameStudio={version:'"+GAME_STUDIO_VERSION+"'");
  return js;
}
...
export function inspectGameStudioProject(files){
  ...
  const checks={...base.checks,
    ...
    publicStudioVersion:js.includes(GAME_STUDIO_VERSION),
