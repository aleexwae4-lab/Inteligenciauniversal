...
const ROLE_MANDATES=Object.freeze({
  aerospace_systems:'Arquitectura aeronáutica y espacial, trazabilidad de requisitos, verificaciones y revisión competente; no certificar aeronavegabilidad.',
  structures_materials:'Integridad estructural, fatiga, materiales y modos de fallo; usar límites de manuales autorizados, nunca inventados.',
  safety_quality:'Gestión de riesgos, calidad, aceptación y liberación profesional sustentada en evidencia verificable.',
  control_systems:'Sistemas de control, telemetría y pruebas de simulación; distinguir análisis de ensayo físico.',
  automotive_diagnostics:'Diagnóstico automotriz por síntomas, historial, códigos y pruebas confirmatorias autorizadas.',
  mechanical_systems:'Mecánica, mecanismos, materiales, cargas, desgaste y mantenibilidad del activo específico.',
  motorcycle_diagnostics:'Diagnóstico y mantenimiento de motocicletas, frenos, transmisión, tren motriz y suspensión.',
  marine_systems:'Ingeniería naval, propulsión, navegación, integridad y mantenimiento marítimo.',
  thermal_systems:'Transferencia térmica, refrigeración, combustión y eficiencia sin suponer parámetros de servicio.',
  industrial_engineering:'Diseño de procesos, capacidad, productividad, flujos, control de calidad y mejora continua.',
  operations_maintenance:'Plan de mantenimiento, criticidad, inventarios, órdenes de trabajo, indicadores y responsables.',
  academic_governance:'Programas académicos, laboratorios, acreditación, estudiantes y continuidad institucional.',
  information_systems:'Arquitectura de sistemas informáticos, datos, soporte, seguridad y continuidad digital.',
  computer_engineering:'Hardware, CPU/GPU, diagnóstico de computadoras y pruebas reproducibles.',
  robotics_control:'Sensores, actuadores, movimiento, seguridad, control y validación previa a operación física.',
  microelectronics:'Arquitectura de chips, lógica, FPGA/ASIC, verificación y distinción entre diseño y silicio validado.',
  manufacturing_quality:'Metrología, variabilidad, defectos, trazabilidad y control de cambios industriales.',
  energy_infrastructure:'Energía, disponibilidad, redundancia, infraestructura y prevención de maniobras inseguras.',
  public_service_design:'Prestación de servicios públicos, accesibilidad, eficiencia y métricas de atención neutral.',
  institutional_governance:'Estructura, responsabilidades, rendición de cuentas y coordinación de organizaciones.',
  security_compliance:'Protección de datos, controles, auditoría y cumplimiento normativo documentado.'
});
...
export function industrialCatalog(){
  return {version:UNIVERSAL_INDUSTRIAL_VERSION,specialistProfileCount:Object.keys(ROLE_MANDATES).length,domains:DOMAINS.map(({id,name,critical,governance,assets,roles})=>({id,name,critical,governance:governance===true,assets:[...assets],roles:[...roles]})),stages:STAGES.map(([id])=>id)};
}
...
export function industrialSystemInstruction(plan){
  ...
  return '\n\nPAQUETE UNIVERSAL DE INGENIERÍA Y CIVILIZACIÓN '+plan.version+
    ...
    '\nEspecialistas aplicables: '+plan.roles.map(role=>role+': '+(ROLE_MANDATES[role]||'Análisis especializado sujeto a documentación')).join('; ')+
