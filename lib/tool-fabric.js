...
export const TOOL_FABRIC_VERSION='universal-tool-fabric/v66-web-intelligence';
...
export const TOOL_DEFINITIONS=Object.freeze([
  {
    id:'web.search',version:'2.0.0',provider:'web_intelligence',capabilities:['web_search','deep_research'],actions:['search'],
    ...
    tags:['web','research','multi-provider','evidence-ranked','read'],
  },
  {
