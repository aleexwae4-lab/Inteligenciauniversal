...
const configured={
  ...
  // DuckDuckGo Instant Answer is a real, limited, keyless read path. Do not confuse\n  // tool activation with complete web-search coverage or verified provider health.\n  web_intelligence:()=>true,
