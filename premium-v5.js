(()=>{
  ...
  function init(){document.documentElement.dataset.waePremiumRich='v43';loadGptExperience();loadProductModules();observe();setTimeout(upgrade,250);setTimeout(upgrade,900)}
  document.readyState==='loading'?document.addEventListener('DOMContentLoaded',init,{once:true}):init();
  window.__waePremiumRich={version:'v43',visibleResponse:GPT_EXPERIENCE_RELEASE,productModules:PRODUCT_MODULES_RELEASE,refresh:upgrade};
})();
