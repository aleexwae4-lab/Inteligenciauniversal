...
import {generateWithGpuFabric,gpuFabricConfigured,gpuFabricSnapshot,GPU_FABRIC_VERSION} from '../lib/gpu-fabric-v75.js';
...
function safeGpuPayload(result,body,previous={}){
  ...
  let payload={
    ...
    reply:text,
    speech_text:text,
    components:[],actions:[],web_sources:[],
...
export default async function capacityChatV75(req,res){
