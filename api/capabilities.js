...
import { webIntelligenceHealthV2 } from '../lib/web/research-v2.js';
...
export default async function handler(req,res){
  ...
  return res.status(200).json({
    ...
    universalWebIntelligence:{...webIntelligenceHealthV2(),endpoint:'/api/web/research',searchEndpoint:'/api/web/search',retrieveEndpoint:'/api/web/retrieve',sourcesEndpoint:'/api/web/sources',healthEndpoint:'/api/web/health',metricsEndpoint:'/api/web/metrics'},
