...
test('all current NVIDIA free endpoints are classified without mixing specialized models into chat', () => {
...
test('learning contract is eval-driven, trial-scoped and does not claim base-weight training', () => {
