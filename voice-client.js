(()=>{
  ...
  let enabled=true,paused=false,voice=localStorage.getItem(VOICE_NAME)||'Kore',context=null,currentSource=null,currentAudio=null,currentUtterance=null,runId=0,queue=[],queueRunning=false,cloudBackoffUntil=0,lastEngine='idle';
