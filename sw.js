...
const CACHE='wae-universal-v37-native-app';
const CORE=['./index.html','./styles.css','./polish-v2.css','./mobile-safe-composer.css','./startup-guard-v23.js','./runtime-client.js','./app.js','./mobile-safe-composer.js','./progressive-boot-v23.js','./mobile-v26.js','./mobile-runtime-v34.js','./mobile-canonical-chat-v80.js','./canonical-brain-v106.js','./premium-v117.css','./premium-v117.js','./manifest.webmanifest','./install-app.js','./assets/universal-core-icon.svg','./assets/logo.svg','./assets/logo-v2.svg'];
